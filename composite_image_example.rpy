...
image blinking01:
    ...
    choice: #the choice here serves as a random timer. Sometimes, the char will blink after 8 seconds, sometimes after 4, and sometimes after 1. This makes it feel more natural.
        8
    choice:
        4
    choice:
